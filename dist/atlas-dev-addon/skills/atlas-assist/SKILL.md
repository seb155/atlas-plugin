---
name: atlas-assist
description: "Master skill for ATLAS Dev — AXOIQ's unified AI engineering assistant. 29 skills, 7 agents. Auto-routing co-pilot with HITL gates."
...
**Tier**: `dev-addon` | **Persona**: senior engineering architect
...
```
🏛️ ATLAS │ ✅ SESSION │ v5.0.2 Dev
   29 skills │ 7 agents │ Gate 12/15
...
### 🛡️ Meta
- 🌐 browser-automation | 📋 decision-log | 🪝 hookify | 🔌 plugin-builder | 🧩 skill-management
