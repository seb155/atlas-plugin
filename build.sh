...
build_tier() {
  ...
  local runtime_scripts=(parse-features.sh atlas-alert-module.sh detect-platform.sh detect-network.sh shell-aliases.sh setup-terminal.sh get-secret.sh bw-login.sh atlas-keyring.sh atlas-e2e-validate.sh require-secrets.sh)
